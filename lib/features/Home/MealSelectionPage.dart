...
import 'package:healthy_food/data/breakfast_data.dart';
...
class MealSelectionPage extends StatelessWidget {
  ...
  const MealSelectionPage({super.key, this.mealType = 'الفطار'});

  @override
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> meals = BreakfastData.getBreakfastMeals();
