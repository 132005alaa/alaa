...
import 'package:healthy_food/data/lunch_data.dart';
...
class LunchSelectionPage extends StatelessWidget {
  final String mealType;

  const LunchSelectionPage({super.key, this.mealType = 'الغداء'});
...
class _LunchCard extends StatelessWidget {
  ...
  const _LunchCard({required this.meal});
                        ...
                        onTap: () async {
                          ...
                          if (context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'تم إضافة $name بنجاح! (+$calories سعرة) 🍽️',
                                ),
